...
public class GUIManager: MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        int arenaSize = (int)arena.value;
        arena.onValueChanged.AddListener(delegate{SetArenaSize(arenaSize);});
        ...
        int speed = (int)playersSpeed.value;
        playersSpeed.onValueChanged.AddListener(delegate
        ...
        int size = (int)playersSpeed.value;
        playersSize.onValueChanged.AddListener(delegate
                                              {SetPlayersSpeed(size);});
